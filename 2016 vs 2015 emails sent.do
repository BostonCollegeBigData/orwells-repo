/*run code code through and at end you will a tabulated list of emails sent in fy2015 and fy2016*/
...
////////////////////////////////////////////////////
////////////year over year emails sent//////////////
////////////////////////////////////////////////////

//fiscal year 2015 - record # of observations
di date("20140601","YMD")
di date("20150531","YMD")
tab date_sent if date_sent>=19875 & date_sent<=20239

//fiscal year 2016 - record # of observations
di date("20150601","YMD")
di date("20160531","YMD")
tab date_sent if date_sent>=20240 & date_sent<=20605
